...
def get_input_args():
    ...
    ###dir=input('Image folder') or 'pet_images'
    ###arch=input('CNN Model Architecture') or 'vgg'
    ###dogfile=input('Text File with Dog names') or 'dognames.txt'
